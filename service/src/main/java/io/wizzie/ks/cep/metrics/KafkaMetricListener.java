...
public class KafkaMetricListener implements MetricListener {
    ...
    public void init(Config config) {
        ...
        topic = config.getOrDefault(METRIC_KAFKA_TOPIC, "__cep_metrics");
        config
                .put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, "org.apache.kafka.common.serialization.StringSerializer")
                .put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, "io.wizzie.ks.cep.serializers.JsonSerializer");
